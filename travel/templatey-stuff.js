...
const data = {
  ...
  rome1: {
    ...
    content:
      "<p>While I was abroad for the full calendar year in 2019 there was a taxes rule that I could only be in America for 33 days. So my deal with my parents was that if they wanted to see me, they'd have to take a trip they've always wanted to take. To Italy!</p><p>My parents arrived in Rome the day before me and did a bunch of tourist things that I had already done the first time around. Full disclosure, I wasn't super impressed with the Rome of it all from a touristy standpoint. I knew they wanted to see that stuff though so I gave them a day ahead. When I got there we hit the Vatican and went to dinner a few times and just caught up really. The best was yet to come. Florence and Venice! So after a day or two wandering around drinking wine and eating pizza, off we went!</p>",
  },
  florence1: {
    title: "Florence, Italy",
    year: "2019",
    ...
    content:
      "<p>Next stop on the parental tour was Florence. We rented one of the most lovely airbnbs I have ever stayed in. It was a tough one to get up the stairs to but it was a <a href='https://www.airbnb.com/rooms/plus/27701630'>perfect location</a> and an amazing place.</p><p>Florence was Italy's time to shine. Slow days filled with lots of walking around followed by big Italian dinners in the evening and a walk home at dark filled with wine and beer. The one tourist thing I did convince my parents was a must do was climbing the steps of the Duomo. We all made it to the top, enjoyed an amazing view, and the moment we headed back inside for the journey back downstairs it started raining. Perfectly timed and an amazing day.</p>",
  },
  venice1: {
    title: "Venice, Italy",
    year: "2019",
    ...
    content:
      "<p>The main event of the 2019 Parents to Italy tour was Venice. We stayed on the island (the only way to go) and a bit off the beaten path in the  Campo San Giacomo area. It is a lovely square full of locals. Actually, NOT full of anyone. Which is kind of the point.</p><p>We enjoyed a lot of walks through the labrynth of sidewalks and squares that is Venice. Weaving in and out of the main areas and the quiet back canals, we jsut explored. Stopped when we were hungry and thirsty, and generally took it easy and sampled the local cuisine. It really was a perfect and relaxing way to catch up with my family that I hadn't seen in months.</p>",
  },
  burano1: {
    title: "Burano, Italy",
    year: "2018",
    ...
    content:
      "<p>Our day trip from the main island took us to Burano. I knew my way around this tiny little paradise from last trip but was introducing it to the fam for the first time. As is tradition, we had a walk around and took photos for a while until settling on a little cafe for some food and drink in the afternoon. There isn't much to say here from a travel and tourist standpoint but spending a slow day with almost nothing to do is a perfect way to unwind. The spot we finally settled in was Riva Rosa, but there are plenty of cute little cafes that would do the trick for a relaxing snack on this beautiful island.</p>",
  },
  vienna: {
    ...
    content:
      "<p>Vienna is an amazing place with a very lively and diverse population. I lived near Prater park when I was there and there were a few things that really stood out about Vienna. First, it is a very active city. Tons of people doing tons of things in the massive public parks all around. It was easy for me to find games of frisbee, basketball, and baseball/softball in spite of these not being particularly European sports. Second, the public transportation system is reliable, cheap, and fast. Maybe the best I have seen in Europe, although many cities have a leg up on Boston in that regard. Lastly, it is English speaking enough where it wasn’t a major hurdle to be able to meet people or go out as it is in other European cities.</p><p>A couple of places that stood out for me were The Red Loin (Liverpool Supporters Pub), Blumenwiese, Prater Park (yes, it has fun rides too, not just a field to play in), The Brickmakers, and anywhere along the Danube.</p><p>There are some lovely places just out of the city as well like Weinhof Zimmerman and Höflein Banhof (for swimming in the Danube!) Vienna also has quite a few great museums to see. As always, the modern art one won the day (MUMOK) for me. But there really is something for everyone with history museums, modern art, and normal gallerries. Great place. Fun city. Highly recommend going and exploring for yourself.</p>",
  },
  krakaw: {
    title: "Krakow, Poland",
    year: "2019",
    ...
    content:
      "<p>Next stop was a weekend with the Lads (Fraz and MarcO) in Poland. It wasn't quite the normal lads weekend, as we wanted to get a bit of history in this trip and a lot of the WWII history is expectedly not on the celebratory side. But it was great to do things like the Schindler Museum and a bit more of the serious stuff. This isn't a history website so I'll keep it brief on the subject and just say that many of the things there are not 'fun' but they are very impoartant and definitely worth visiting and honoring.</p><p>Other things we did while we were there that were a bit more fun were the nightly pierogi runs and the salt mines. The salt mines were some of the most unbelievable things I have ever seen. I still cannot wrap my head around the sheer scale and the time it must have taken to build them. The chappel that is carved into a cavern underground is truly amazing. If you can get over the slight anxiety that comes from being half a mile underground, then this is definitely a must see if you go to Krakow.</p>",
  },
  bar: {
    ...
    content:
      "<p>I spent 2 months in Bar living in an Airbnb about 5 minutes walk from the beach. It was a relaxing summer destination and definitely a chance of pace from the city life I had been living in for years. While Bar gets lively along the beach at night, there is definitely something to be said for how quiet it is. The Old Town (fortress and road) are both cute destinations and the Old Olive Tree (well over 2000 years old) is worth seeing. But most of the action is in the surrounding seaside town of Budva (the nightlife destination of Montenegro).</p><p>One thing is for sure, there is no beating the sunsets in Bar. The food is not very diverse but there is good Italian food everywhere since its just across the sea. The mountains just off the coast make for an amazing scenic backdrop to everyday life as well. I would recommend renting a car and going to see places like Lake Skadar, Bay of Kotor, and Dobra Voda.</p><p>Bar. Good for a few days, not enough to do for a long term stay unless you are truly ready to relax and take it slow by the sea.</p>",
  },
  kotor: {
    ...
    content:
      "<p>The Bay of Kotor is an extremely beautiful place located just south of Croatia on the Adriatic sea. Kotor itself is a small town located at the innermost point of the bay. The entire vibe of the town depends on if the massive cruise ship is in the port (its packed) or if it is gone (its quiet-ish).</p><p>I stayed for a week in the neighboring town of Dobrota at a lovely little airbnb with a balcony with an outstanding view. Ony of my favorite parts is that no matter where you are you can walk down to the water and walk along the tiny road to Kotor and stop anywhere and just hop in to swim or stop at one of the amazing little places to eat right on the bay. Prices are very cheap by Euro-standards as well.</p><p>The other highlight of my time there was the boat tour of the bay. There are many to choose from and I presume most go to similar places, but make sure to go see the blue caves. They are seaside caves with crystal clear water that you can swim in. It is truly a spectacular experience.</p>",
  },
  skadar: {
    ...
    content:
      "<p>I made this drive a few times but I would recommend you take this route and when you see a photo spot to stop, have at it. There is also a tiny little shack with smoothies and snacks about halfway around. You’ll see it. Anyway, <a href='https://goo.gl/maps/YLuW2VAM98FgRyUh7'>here is the driving route</a> for peak scenery, Enjoy!</p>",
  },
  belgrade: {
    ...
    content:
      "<p>Personally, I was just excited to get back to a big city after a few months in a quiet beach town. Finally there were tons of people, basketball games, pubs, and a modern art museum.</p><p>My favorite areas oof the city are Ada Island, The Fortress, and The Bohemian district. There are some amazing places to eat, far too many to name but I would definitely single out Toro and Sofa down by the river. They are right on the water and some of the most eclectic menus in town. Fois gras ravioli, roast duck, Spanish croquettes, chicken empanadas, and much much more.</p>",
  },
  tallinn: {
    ...
    content:
      "<p>Tallinn was one of those cities where I could legitimately move to and be happy living there. Old town is so beautiful and there are so many pubs and mid-evil places to explore that it is just a seemingly never ending maze of happiness. Outside of old town it is a modern city with a ton of tech innovation.</p><p>A few great spots to hang out around town for locals and tourists alike are Patkuli viewing platform, St. John’s Church, Kadriorg Park, and of course Tallinna raekoda (the main square and home of the Christmas Market)</p><p>The Christmas Market was one of my favorite things I have ever done. Constant Christmas music, stands full of stockings, chocolates, ornaments, and other Christmas items, as well as traditional food and drink like hot wine and black pudding pack the town square. It was truly one of the most magical places I have ever been and I spent every day I could down there for the week that it overlapped with my stay.</p>",
  },
  hamburg: {
    ...
    content:
      "<p>My friend Andrea had extended an offer for me to visit her in Germany so I had a long weekend while I was over in Europe and took her up on it. While she was working the first few days I had a bunch of long walks around the city. Mostly doing a few laps around Aussen Alster.</p><p>There are honestly too many outstanding food places to name in Hamburg. I don’t think I had a single bad meal the entire time I was there. I will say a special shout out to Cheesecake Heaven — Der Käsekuchenladen for the incredible dessert and to Restaurant Im Sprinkenhof for the incredible schnitzel and mash.</p><p>We visited a couple of awesome tourist spots like Photohaus, Rathaus, and Elbphilharmonie for some great views and sight seeing.</p>",
  },
  helsinki: {
  ...
  tromso: {
    ...
    content:
      "<p>I headed up north of the Arctic circle in the winter of 2019 to check some things off the bucket list. I was hoping to dogsled and see the northern lights, but 4 days straight of snow meant the lights were pretty much off the table, luckily, the dogs more than made up for it. 300 Huskies! I died and went to heaven. <a href='https://www.youtube.com/watch?v=K7WwhQInLCk'>Here is the video.</a></p><p>Other Tromsø sights… well there really aren’t many “sights”. Its just a cute little arctic town on a hill. I will say that the place I stayed (Clarion on the edge) was a beautiful and well kempt and right on the bay. The best place to eat was a tiny little hot dog stand in the town center called Raketten Bar & Pølse. Google doesn’t have the right location though, its really where google places “Storgata 94B, Tromso” at, so google that.</p>",
  },
  brussels1: {
    ...
    content:
      "<p>One last week with the lads before heading home for a while brough us (MarcO, Fraz, and Phil) to Brussels for the week. We had an amazing time wandering around, eating fries and waffles, and going out drinking. It was truly a lads holiday.</p><p>Our best night there was a night out with a local though. My old friend from college Mayssa and her boyfriend live in Brussels now and they shows us the coolest bar I've ever been to. Le Goupil, an old converted brothel, is a maze of candlelit rooms, couches, and bartops. It was comfy, fun, and a great place to gather with friends to play cards, have a few drinks, and just generally have a great time. I wish there were more places this unique around. I would go back in a second and I highly recommend it if you are ever in Brussels.</p><p>We also got a bit of history in between walking around at Halle Gate in the southern tip of the city. It was small but definitely scratched our history itch for the trip.</p>",
  },
  halifax: {
    ...
    content:
      "<p>Halifax was the last stop before returning home for a while (what would turn out to be years thanks to covid-19). It was a pit stop on my side of the pond between Thanksgiving and Christmas to meet an old friend Anna.</p><p>Anna was super hospitable in letting me stay with her in her spare room and entertaining me when she wasn't busy with other things like school and work.</p><p>I managed to walk to the little downtown area quite often since I wasn't working while I was there and tucked in to the local Liverpool Supporters Pub Durty Nelly's. While watching the mighty reds there I met a handful of locals and transplants. It was a great time with very hospitable people and the friendliest of locals. It may also have helped that LFC were the best club in the world at the time and on their way to a league title for the first time in 30 years while also being the Champions League holders.</p>",
  },
  paris2: {
    title: "Paris, France",
    year: "2022",
    ...
    content:
      "<p>The first trip back after covid was always going to be a big one. This is the best one imaginable, my favorite country, my favorite people, friends from all around, and the Champions League Final tickets in hand.</p><p>The match and that evening left a bit to be desired for multiple reasons that you can look up in the news. But the week started off amazingly. Jane and I set off from Boston and met her friend Natasha for tapas. Day two saw us meet up with the rest of the lads MarcO, Hunter, and Fraz for an airbnb that rivaled living with Fraz himself for 4 months. Great jokes, games, snacks, drinks, and the rest. We took our time through Paris that week with nice meals, late night walks all around, and pubs at both end of the spectrum of niceness.</p><p>The highlight for me was probably Jane and Natasha having a chugging contest. Then Jane and MarcO. Then Jane and Natasha again. The night didn't turn out well for Natasha, but it was an amazingly fun time and I'm pretty sure even Natasha wouldn't change a thing.</p><p>As is tradition, the lads also made a day trip to Centre Pompediu. My third time, and again, the best museum in the world for my money. This was also the scene of the famous tattoo escapade for Jane's first tat. A scissors on her shoulderblade and a matching one on Natasha's. Good times.</p>",
  },
  lyon1: {
    title: "Lyon, France",
    year: "2019",
    ...
    content:
      "<p>The second leg of the vacation saw Jane and I leave the lads to go home as we went down to Lyon to slow it down in a bit more calm of a city. I missed Lyon a lot and I was really excited to see my friends Jeanne and Theresa as well. T flew in from Austria just for the visit! We didn't really do much besides wander around, play arcade games, eat, and drink but it was a great time. I suspect that most of my travels from now on will just be catching up with old friends over meals and beverages in the most fun and beauitful places possible. Not a problem for me!</p><p>This was a great few days of relaxation and stolls down memory lane to all my old favorite Lyon spots.</p>",
  },
  annecy: {
    title: "Annecy, France",
    year: "2019",
    ...
    content:
      "<p>Jeanne was nice enough to pile all of us into her tiny little Euro car and drove us the few hours to Annecy. Annecy is an amazing little lakeside town tucked into the mountains. Ice cream shops every 20 feet to choose from and little paddle boats to rent to get to the middle of the lake for some even more spectacular views.</p><p>We spent the day walking around, eating, taking photos, and you guessed it, just relaxing. Every little street in this village was picture perfect. The food was great, the views were second to none. And when we got to the other side of the lake we even got a little cliff diving show from a local who took the big jump into the lake for us while we cheered him on. It was a great day.</p>",
  }
};
